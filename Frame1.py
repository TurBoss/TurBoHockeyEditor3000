...
class Frame1(wx.Frame):
    ...
    def _init_ctrls(self, prnt):
        ...
        self.minCtrl1.SetToolTip(u'Minutes')
        ...
        self.secCtrl1.SetToolTip(u'Seconds')
        ...
        self.shootCtrl1.SetToolTip(u'Super shoot time')
        ...
        self.choice1.SetToolTip(u'Field 5 music theme')
        ...
        self.choice2 = wx.Choice(choices=[], id=wxID_FRAME1CHOICE2,
                                 ...
                                 size=wx.Size(48, 21), style=0)
        self.choice2.SetToolTip(u'Field 2 music theme')
        ...
        self.choice3 = wx.Choice(choices=[], id=wxID_FRAME1CHOICE3,
                                 ...
                                 size=wx.Size(48, 21), style=0)
        self.choice3.SetToolTip(u'Field 3 music theme')
        ...
        self.choice4 = wx.Choice(choices=[], id=wxID_FRAME1CHOICE4,
                                 ...
                                 size=wx.Size(48, 21), style=0)
        self.choice4.SetToolTip(u'Field 4 music theme')
        ...
        self.checkBox1.SetToolTip(u'Enable / Disable penalty')
        ...
        self.button1.SetToolTip(u'Load rom')
        ...
        self.button2 = wx.Button(id=wxID_FRAME1BUTTON2, label=u'Save',
                                 ...
                                 size=wx.Size(75, 23), style=0)
        self.button2.SetToolTip(u'Save rom')
        ...
        self.choice5 = wx.Choice(choices=[], id=wxID_FRAME1CHOICE5,
                                 ...
                                 size=wx.Size(48, 21), style=0)
        self.choice5.SetToolTip(u'Field 1 music theme')
    ...
    def __init__(self, parent):
        ...
        self.team1 = Team(self.team1NameOffset, self.team1StatsOffset, self.players1NameOffset,
                          self.players1ShootOffset, self.players1DisplayStatsOffset)
        self.team2 = Team(self.team2NameOffset, self.team2StatsOffset, self.players2NameOffset,
                          self.players2ShootOffset, self.players2DisplayStatsOffset)
        self.team3 = Team(self.team3NameOffset, self.team3StatsOffset, self.players3NameOffset,
                          self.players3ShootOffset, self.players3DisplayStatsOffset)
        self.team4 = Team(self.team4NameOffset, self.team4StatsOffset, self.players4NameOffset,
                          self.players4ShootOffset, self.players4DisplayStatsOffset)
        self.team5 = Team(self.team5NameOffset, self.team5StatsOffset, self.players5NameOffset,
                          self.players5ShootOffset, self.players5DisplayStatsOffset)
        self.team6 = Team(self.team6NameOffset, self.team6StatsOffset, self.players6NameOffset,
                          self.players6ShootOffset, self.players6DisplayStatsOffset)
        self.team7 = Team(self.team7NameOffset, self.team7StatsOffset, self.players7NameOffset,
                          self.players7ShootOffset, self.players7DisplayStatsOffset)
        self.team8 = Team(self.team8NameOffset, self.team8StatsOffset, self.players8NameOffset,
                          self.players8ShootOffset, self.players8DisplayStatsOffset)
    ...
    def saveRom(self):
        ...
        self.team1.writePlayerStats(self.rom, self.players1StatsOffset, (
        self.team1Player1Stats, self.team1Player2Stats, self.team1Player3Stats, self.team1Player4Stats,
        self.team1Player5Stats))
        self.team2.writePlayerStats(self.rom, self.players2StatsOffset, (
        self.team2Player1Stats, self.team2Player2Stats, self.team2Player3Stats, self.team2Player4Stats,
        self.team2Player5Stats))
        self.team3.writePlayerStats(self.rom, self.players3StatsOffset, (
        self.team3Player1Stats, self.team3Player2Stats, self.team3Player3Stats, self.team3Player4Stats,
        self.team3Player5Stats))
        self.team4.writePlayerStats(self.rom, self.players4StatsOffset, (
        self.team4Player1Stats, self.team4Player2Stats, self.team4Player3Stats, self.team4Player4Stats,
        self.team4Player5Stats))
        self.team5.writePlayerStats(self.rom, self.players5StatsOffset, (
        self.team5Player1Stats, self.team5Player2Stats, self.team5Player3Stats, self.team5Player4Stats,
        self.team5Player5Stats))
        self.team6.writePlayerStats(self.rom, self.players6StatsOffset, (
        self.team6Player1Stats, self.team6Player2Stats, self.team6Player3Stats, self.team6Player4Stats,
        self.team6Player5Stats))
        self.team7.writePlayerStats(self.rom, self.players7StatsOffset, (
        self.team7Player1Stats, self.team7Player2Stats, self.team7Player3Stats, self.team7Player4Stats,
        self.team7Player5Stats))
        self.team8.writePlayerStats(self.rom, self.players8StatsOffset, (
        self.team8Player1Stats, self.team8Player2Stats, self.team8Player3Stats, self.team8Player4Stats,
        self.team8Player5Stats))
    ...
    def OnButton1Button(self, event):
        ...
        with wx.FileDialog(self, "Load Ike Ike Hockey ROM", wildcard="nes files (*.nes)|*.nes",
    ...
    def OnButton2Button(self, event):
        ...
        with wx.FileDialog(self, "Save Ike Ike Hockey ROM", wildcard="nes files (*.nes)|*.nes",
